            ...
            <div class="row">
                <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" name="ticketnumber" id="ticketnumber" placeholder="Ticket Number" autofocus required onblur="get_estimation_function()">
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    <script type="text/javascript">
         function get_estimation_function() {
                    ...
                    success: function(response) {
                        var prev_completepercentage = response.prev_completepercentage;
                        for(var i = prev_completepercentage; i <= 100 ;i++)
                        {
                            
                        }
                        $('#completepercentage').val(response.prev_completepercentage);
                        $('#remainingtime').val(response.prev_remainingtime);
                        $('#estimatedtime').val(response.prev_estimatedtime);
        ...
        $(document).ready(function() {
            ...
            $('#add_more').click(function(e){
              ...
              //console.log(ticketnumber,comments);
