...
if ($db) {
    ...
    if ($success === 1) {
        echo json_encode(array('status' => 'success', 'message' => 'You have successfully submitted your end of the day report', 'error_msg' => $error_msg));
    }
} else {
    echo json_encode(array('status' => 'error', 'message' => 'Database connection failure'));
}
?>
